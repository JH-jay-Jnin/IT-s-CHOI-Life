...
//import App from './App.vue'; // 나 (main.js)를 기준으로 동일 파일 내에 있는 App.vue를 App이라고 import 할 것이다.
// import App from './App2.vue'; // 기본 컴포넌트 말고 2 컴포넌트 사용하기 // 객체를 이용한 props 전달
...
// createApp(App).component('CheckboxItem1', CheckboxItem).mount('#app');

createApp(App).mount('#app');
// 그리고 그 App.vue 화면을 가지고 만들겠다. (index 내에 있는 App이라는 id를 가진 애를 통해서. )
// 즉 다시 말해, App.vue를 기반으로 Vue 앱을 만들어서
